...
import sty from "./PlasmicPublicCardFigma.module.css"; // plasmic-import: M6f8TVuHxw-J/css
import Rectangle296Icon from "../applicant_tracking_system/icons/PlasmicIcon__Rectangle296"; // plasmic-import: sN7EKKcgAhB7/icon
import VectorIcon from "../applicant_tracking_system/icons/PlasmicIcon__Vector"; // plasmic-import: weFgsDumIobu/icon
import Arrow7Icon from "../applicant_tracking_system/icons/PlasmicIcon__Arrow7"; // plasmic-import: t-zShSNNSTA6/icon

createPlasmicElementProxy;

export const PlasmicPublicCardFigma__VariantProps = new Array();

export const PlasmicPublicCardFigma__ArgProps = new Array();
...
function PlasmicPublicCardFigma__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicPublicCardFigma__ArgProps,
          internalVariantPropNames: PlasmicPublicCardFigma__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicPublicCardFigma__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicPublicCardFigma";
  } else {
    func.displayName = `PlasmicPublicCardFigma.${nodeName}`;
  }
  return func;
}

export const PlasmicPublicCardFigma = Object.assign(
  // Top-level PlasmicPublicCardFigma renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicPublicCardFigma
    internalVariantProps: PlasmicPublicCardFigma__VariantProps,
    internalArgProps: PlasmicPublicCardFigma__ArgProps
  }
);

export default PlasmicPublicCardFigma;
/* prettier-ignore-end */
